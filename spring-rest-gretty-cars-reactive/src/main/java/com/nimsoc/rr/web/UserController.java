...
import com.nimsoc.rr.exception.ErrorCode;
import com.nimsoc.rr.exception.ProhibitedOperationException;
import com.nimsoc.rr.model.Car;
import com.nimsoc.rr.model.ErrorResponse;
...
public class UserController {
  ...
  public ResponseEntity<?> register(@Valid @RequestBody User user, BindingResult result) {
    ...
    } else if (service.findByUserName(user.getUserName()).blockFirst() != null) {
