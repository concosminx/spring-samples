...
public class TravelDestinationsDetails {
  ...
  //http://localhost:8080/travel/destination-details/CUCUBAU - result in close circuit
  ...
  public String reliable(String cityName) {
    return "{ \"msg\": \"Info about city: " + cityName + " is not currently available\"}";
  }
}
