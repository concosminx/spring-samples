...
public class KafkaApplication {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * Sending a Hello World message to topic 'supadupa'.
		 ...
		 */
		producer.sendMessageToFiltered("Hello Boss!");
		producer.sendMessageToFiltered("Hello World!");
		listener.filterLatch.await(10, TimeUnit.SECONDS);

		/*
		 * Sending message to 'user' topic. This will send
		 * and received a java object with the help of
		 * userKafkaListenerContainerFactory.
		 */
		producer.sendUserMessage(new User(23, "JohnDoe!"));
		listener.userLatch.await(10, TimeUnit.SECONDS);
