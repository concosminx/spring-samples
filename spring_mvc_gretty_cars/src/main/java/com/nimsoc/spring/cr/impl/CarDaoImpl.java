...
import com.nimsoc.spring.cr.dao.CarDao;
import com.nimsoc.spring.cr.model.Car;
import com.nimsoc.spring.cr.model.CarRowMapper;
...
public class CarDaoImpl implements CarDao {
  ...
  public Car save(Car car) {
    ...
    return findOne((Integer)keyHolder.getKeys().get("car_id"));
  }
  ...
  public List<Car> findAll() {
    ...
    List<Car> cars = jdbcTemplate.query(queryCar, new BeanPropertyRowMapper<>(Car.class));
    return cars;
  }
  ...
  public final void createTable() {
    String query = "create table IF NOT EXISTS cars(car_id SERIAL not null, license_plate varchar(10) not null ,cost integer not null, manufacturer varchar(10) null, PRIMARY KEY (car_id))";
    jdbcTemplate.execute(query);
  }

  public boolean findUserMapping(int carId) {
    try {
      jdbcTemplate.queryForObject("select * from user_car where carId=?", new Object[]{carId}, new BeanPropertyRowMapper<>(UserCar.class));
      return true;
    } catch (EmptyResultDataAccessException e) {
      return false;
    }
