package com.nimsoc.spring.cr.web;
...
import com.nimsoc.spring.cr.exception.ErrorCode;
import com.nimsoc.spring.cr.exception.ProhibitedOperationException;
...
public class UserController {
  ...
  List<String> createErrorList(BindingResult result) {
    ...
    result.getAllErrors().forEach((object) -> {
